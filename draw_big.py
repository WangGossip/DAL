...
def draw_multi_data(list_data, outpath, str_exp, str_type='Acc'):
    ...
    my_x_ticks = [1, 2, 3, 4, 5, 6, 7, 8, 9]
    # my_y_ticks = np.arange(79, 98.5, 0.1)
    # 画图开始
    plt.figure(figsize=(7.2,6), dpi=120)
...
def use_mnist_data():
    ...
    # *RS 
    list_mnist_data[0].add_final_acc([0.8009, 0.88232, 0.906, 0.92484, 0.93256, 0.9422, 0.94754, 0.95202, 0.9561, 0.95706], 0.9518)
    list_mnist_data[0].add_final_acc([0.8, 0.8823, 0.906, 0.9248, 0.9326, 0.9422, 0.9475, 0.9520, 0.9561, 0.9570], 0.9518)
    # *BvSB
    ...
    list_mnist_data[1].add_final_acc([0.8009, 0.9127, 0.9424, 0.9526, 0.9631, 0.9724, 0.9754, 0.9764, 0.97893, 0.9799], 0.9810)
    list_mnist_data[1].add_final_acc([0.8, 0.9127, 0.9424, 0.9526, 0.9631, 0.9724, 0.9754, 0.9764, 0.9789, 0.9799], 0.9810)
    ...
    list_mnist_data[2].add_final_acc([0.8, 0.9022, 0.9363, 0.9532, 0.9651, 0.9674, 0.9734, 0.9754, 0.9783, 0.9796], 0.9796)


    # *K-Center-Greedy
    list_mnist_data[3].add_final_acc([0.8, 0.8917, 0.9257, 0.9371, 0.9416, 0.9551, 0.9598, 0.9619, 0.9664, 0.9707], 0.9702)
    # *BALD
    list_mnist_data[4].add_final_acc([0.8009, 0.88238, 0.92498, 0.94944, 0.96056, 0.96866, 0.97316, 0.97582, 0.97834, 0.98068], 0.9808)
    list_mnist_data[4].add_final_acc([0.8, 0.8824, 0.9250, 0.9494, 0.9606, 0.9687, 0.9732, 0.9758, 0.9783, 0.9807], 0.9808)
    ...
    list_mnist_data[5].add_final_acc([0.8, 0.9219, 0.9464, 0.9582, 0.9652, 0.974, 0.9773, 0.9807, 0.9827, 0.9844], 0.9830)
...
def use_fashionmnist_data():
    ...
    list_fashionmnist_data[1].add_final_acc([0.6192, 0.7835, 0.8325, 0.872, 0.8804, 0.8892, 0.9039, 0.9076, 0.9078, 0.9071], 0.9260)
    # *LC
    ...
    list_fashionmnist_data[2].add_final_acc([0.6192, 0.675, 0.7362, 0.8412, 0.8717, 0.8871, 0.893, 0.9001, 0.9041, 0.9071], 0.923)
    # *K-Center-Greedy
    list_fashionmnist_data[3].add_final_acc([0.6192, 0.63708, 0.70584, 0.80566, 0.84892, 0.87284, 0.88486, 0.89096, 0.89604, 0.9024], 0.9124)
    # *BALD
    list_fashionmnist_data[4].add_final_acc([0.6192, 0.6565, 0.70358, 0.77612, 0.82904, 0.85728, 0.8759, 0.88376, 0.88654, 0.89234], 0.8995)
    # *BMMC
    ...
    list_fashionmnist_data[5].add_final_acc([0.6192, 0.7597, 0.8523, 0.8749, 0.8891, 0.8997, 0.9025, 0.9058, 0.9089, 0.9132], 0.9286)
...
def use_cifar10_data():
    ...
    list_cifar10_data[5].add_final_acc([0.5068, 0.6482, 0.7239, 0.7716, 0.8101, 0.8371, 0.8491, 0.8658, 0.8764, 0.8886], 0.9237)
...
def use_cifar10im3_data():
    ...
    list_cifar10im3_data[0].add_final_acc([0.2974, 0.3549, 0.4154, 0.4675, 0.5011, 0.537, 0.5623, 0.5703, 0.5867, 0.6142], 0.9015)    
    # *RS
    list_cifar10im3_data[1].add_final_acc([0.2974, 0.338, 0.3819, 0.401, 0.4166, 0.4362, 0.4615, 0.469, 0.4859, 0.5147], 0.8311)
    # *BvSB
    list_cifar10im3_data[2].add_final_acc([0.2974, 0.3551, 0.3881, 0.4478, 0.4649, 0.4845, 0.5055, 0.5228, 0.5338, 0.5454], 0.8911)
    # *K-Center-Greedy
    ...
    list_cifar10im3_data[3].add_final_acc([0.2974, 0.3533, 0.4033, 0.4563, 0.4836, 0.4992, 0.5203, 0.5357, 0.5471, 0.574], 0.8775)    
...
def use_cifar10im2_data():
    ...
    list_cifar10im2_data[0].add_final_acc([0.3373, 0.4415, 0.527, 0.5518, 0.5872, 0.6141, 0.6488, 0.6689, 0.686, 0.7214], 0.8584)
    # *RS
    list_cifar10im2_data[1].add_final_acc([0.3373, 0.42174, 0.47544, 0.49978, 0.52614, 0.5509, 0.56928, 0.5825, 0.6028, 0.62348], 0.7901)
    # *BvSB
    list_cifar10im2_data[2].add_final_acc([0.3373, 0.42208, 0.4841, 0.52998, 0.5683, 0.59622, 0.62149, 0.646153, 0.667073, 0.688873], 0.8577)
    # *K-Center-Greedy
    list_cifar10im2_data[3].add_final_acc([0.3373, 0.4276, 0.492486, 0.53503, 0.57362, 0.603047, 0.627787, 0.650413, 0.668193, 0.690587], 0.8333)
...
def use_cifar10im1_data():
    ...
    list_cifar10im1_data[0].add_final_acc([0.36511, 0.4908, 0.5478, 0.6038, 0.6425, 0.6688, 0.6958, 0.7081, 0.7268, 0.7467], 0.8234)
    # *RS
    list_cifar10im1_data[1].add_final_acc([0.36511, 0.4562, 0.50398, 0.53932, 0.56924, 0.59904, 0.61846, 0.6385, 0.65676, 0.67598], 0.7695)
    # *BvSB
    ...
    # *K-Center-Greedy
    list_cifar10im1_data[3].add_final_acc([0.36511, 0.47622, 0.53635, 0.58389, 0.61749, 0.64842, 0.67332, 0.69504, 0.71412, 0.73394], 0.8152)
...
def use_cifar10im0_data():
    ...
    list_cifar10im0_data[0].add_final_acc([0.39377, 0.5181, 0.5806, 0.6319, 0.6748, 0.701, 0.7346, 0.7547, 0.7687, 0.7918], 0.8281)
    # *RS
    list_cifar10im0_data[1].add_final_acc([0.39377, 0.4562, 0.50398, 0.53932, 0.56924, 0.59904, 0.61846, 0.6385, 0.65676, 0.67598], 0.7695)
    # *BvSB
    ...
    # *K-Center-Greedy
    list_cifar10im0_data[3].add_final_acc([0.39377, 0.48979, 0.55744, 0.60281, 0.63576, 0.66323, 0.68442, 0.70803, 0.72781, 0.74133], 0.7811)
    
    return list_cifar10im0_data

def use_mnist_bm_data():
    list_mnist_bm_data = []
    methods_name = ['BMMC', 'DRAL4', 'DRAL5', 'DRAL6']
    DATA_NAME = 'MNIST'
    count_samples = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
    for method_name in methods_name:
    ...
    list_mnist_bm_data[0].add_final_acc([0.8233, 0.9054, 0.9336, 0.9497, 0.9599, 0.9659, 0.9702, 0.9738, 0.981, 0.9827], 0.9827)
    # *BMCore4
    ...
    list_mnist_bm_data[1].add_final_acc([0.8233, 0.9222, 0.9395, 0.9572, 0.9659, 0.9676, 0.9713, 0.9725, 0.9737, 0.9785], 0.9796)
    # *BMCore5
    list_mnist_bm_data[2].add_final_acc([0.8233, 0.90478, 0.93459, 0.95113, 0.96069, 0.96698, 0.97173, 0.97394, 0.97661, 0.9785], 0.9804)
    # *BMCore6
    list_mnist_bm_data[3].add_final_acc([0.8233, 0.90578, 0.93544, 0.95339, 0.96116, 0.96842, 0.9726, 0.97437, 0.97704, 0.97853], 0.9807)
...
def use_fashionmnist_bm_data():
    ...
    list_fashionmnist_bm_data[0].add_final_acc([0.60523, 0.7597, 0.8523, 0.8749, 0.8891, 0.8997, 0.9025, 0.9058, 0.9069, 0.9132], 0.9286)        
    # *BMCore4
    ...
    # *BMCore5
    list_fashionmnist_bm_data[2].add_final_acc([0.60523, 0.71989, 0.81862, 0.86243, 0.88477, 0.894, 0.89998, 0.90443, 0.90515, 0.91014], 0.92784)
    # *BMCore6
    list_fashionmnist_bm_data[3].add_final_acc([0.60523, 0.67126, 0.7672, 0.81803, 0.85588, 0.87902, 0.89567, 0.90146, 0.9035, 0.90919], 0.9275)
...
def use_cifar10_bm_data():
    ...
    list_cifar10_bm_data[0].add_final_acc([0.5071, 0.647, 0.7301, 0.7821, 0.8048, 0.8327, 0.8513, 0.864, 0.8817, 0.8883], 0.92165)
    # *BMCore4
    ...
    # *BMCore5
    list_cifar10_bm_data[2].add_final_acc([0.5071, 0.64538, 0.72568, 0.7779, 0.80755, 0.83256, 0.84942, 0.86333, 0.87525, 0.8834], 0.9214)
    # *BMCore6
    list_cifar10_bm_data[3].add_final_acc([0.5071, 0.64562, 0.72689, 0.77665, 0.80462, 0.83138, 0.84993, 0.8622, 0.8746, 0.88296], 0.9202)
...
def main():
    ...
    draw_multi_data(list_mnist_data, outpath, 'EXP1')
    # ~FashionMNIST数据
    list_fashionmnist_data = use_fashionmnist_data()
    draw_multi_data(list_fashionmnist_data, outpath, 'EXP1')
    # ~CIFAR10数据
    list_cifar10_data = use_cifar10_data()
    draw_multi_data(list_cifar10_data, outpath, 'EXP1')
    ...
    for data in list_fashionmnist_data:
        print('data:{}; method:{}; 剩余训练集精度: {}; 测试集精度为：{}'.format(data.dataset, data.method, data.trpre_acc, data.list_finacc[-1]))
    for data in list_cifar10_data:
        print('data:{}; method:{}; 剩余训练集精度: {}; 测试集精度为：{}'.format(data.dataset, data.method, data.trpre_acc, data.list_finacc[-1]))
